...
pub fn format_path(pathname: &str) -> String {
...
fn derive_signing_key(auth: &Authorization) -> Result<Vec<u8>, Box<dyn std::error::Error>> {
    ...
    Ok(hmac_sign(&k_service, KEY_TYPE_IDENTIFIER.as_bytes()))
}
