...
impl VerifierCredential {
    ...
    pub fn import(export: VerifierCredentialExport) -> Result<Self, CredentialExportError> {
        ...
        Ok(Self(Ed25519Verifier(
            crate::ed25519::Ed25519VerifyingKey::Native(vk),
        )))
    }
}
...
impl VerifierCredential {
    ...
    pub fn export(&self) -> VerifierCredentialExport {
        ...
        VerifierCredentialExport(js_sys::Uint8Array::from(bytes.as_slice()).into())
    }
    ...
    pub fn import(export: VerifierCredentialExport) -> Result<Self, CredentialExportError> {
        ...
        let array: &js_sys::Uint8Array = export
            .0
            .dyn_ref()
