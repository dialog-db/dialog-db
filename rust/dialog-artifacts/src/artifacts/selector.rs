...
/// domain half and a name half. Constraining only the domain (via
/// [`with_domain`](Self::with_domain)) selects every artifact whose
/// domain matches, enabling a contiguous prefix scan of the attribute
/// index. Constraining both yields a fully-bound attribute.
/// Composite-attribute handling lives at the layer above this one.
///
