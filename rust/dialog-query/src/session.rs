...
impl<S: Store> Session<S> {
    ...
    where
        M: Application + Default + Into<ConceptPredicate>,
        W: When,
    {
        let query = M::default();
        let concept: ConceptPredicate = query.clone().into();
...
mod tests {
    ...
    use crate::{
        ...
        concept::predicate::ConceptPredicate,
    };
    ...
    async fn test_rule() -> anyhow::Result<()> {
        ...
        let employee_predicate: crate::concept::predicate::ConceptPredicate =
        ...
        let stuff_predicate: crate::concept::predicate::ConceptPredicate =
